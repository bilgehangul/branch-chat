    ...
    <div className={`flex h-screen bg-stone-50 dark:bg-zinc-900 text-stone-900 dark:text-slate-100${isResizing ? ' select-none cursor-col-resize' : ''}`}>
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="h-12 bg-white dark:bg-zinc-900 border-b border-stone-200 dark:border-zinc-700 flex items-center px-4 flex-shrink-0 gap-2">
          ...
          <ThemeToggle />
          {/* Manage Keys button — opens Settings modal */}
          <button
            onClick={openSettings}
            aria-label="Open settings to manage API keys"
            className="text-sm px-3 py-1.5 rounded-lg border border-stone-300 dark:border-zinc-600 text-stone-600 dark:text-slate-300 hover:bg-stone-100 dark:hover:bg-zinc-700 transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-zinc-900 outline-none font-medium"
          >
            Manage Keys
          </button>
